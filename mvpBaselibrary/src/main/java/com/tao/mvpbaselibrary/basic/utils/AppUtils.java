...
public class AppUtils {
     ...
     * View获取Activity的工具
     *
     * @param view com.baijiayun.zywx.module_public.view
     * @return Activity
     */
    public static
    @NonNull
    ...
    /**
     * The {@code fragment} is added to the container com.baijiayun.zywx.module_public.view with id {@code frameId}. The operation is
