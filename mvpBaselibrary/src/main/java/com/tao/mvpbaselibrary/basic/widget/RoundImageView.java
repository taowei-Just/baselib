...
public class RoundImageView extends AppCompatImageView {
     ...
     * 圆角半径
     */
    private int currRound = (int) DensityUtil.dp2px(10);
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currMode = a.hasValue(R.styleable.RoundImageView_round_type) ? a.getInt(R.styleable.RoundImageView_round_type, MODE_NONE) : MODE_NONE;
    ...
    public void setRoundRadiusDP(int radiusDP) {
        this.currRound = (int) DensityUtil.dp2px(radiusDP);
    }
}
